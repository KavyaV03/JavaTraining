package com.SyncAsync;

import java.util.List;
import java.util.concurrent.*;
import java.util.stream.*;

public class AsyncFn {
	...
	private static void chainOfCallbackMethods() {
		CompletableFuture<Void> future = CompletableFuture.supplyAsync(() -> {
			...
			return "Deeps";
		}).thenApply(msg -> msg + " Deeps welcomes you all").thenApply(value -> "Hello from " + value + " !!!")
				.thenAccept(System.out::println).thenApply(msg -> msg + " Deeps welcomes you all").thenAccept(System.out::println);
	...
	private static void allOfMethod() {
		...
		CompletableFuture<Integer[]> cFuture3 = CompletableFuture.supplyAsync(() -> {
			Integer a[]= {1, 2};
			return a;
		                                                                              });
		...
		List combined = Stream.of(cFuture1, cFuture2, cFuture3).map(CompletableFuture::join)
