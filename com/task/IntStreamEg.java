...
public class IntStreamEg {
	...
	public static void main(String[] args) {
	  ...
	  System.out.println("*****************************************");
	  System.out.println(IntStream.range(0,4).sum()); //1+2+3+4
	  System.out.println(IntStream.rangeClosed(-2, 4).sum()); 
	  
	  System.out.println("Reduce : " + IntStream.of(va).reduce(5, (x,y)->x+x));
